...
import com.jellymold.boss.ImageSearch;
import com.jellymold.boss.ImageSearchResult;
...
public class ImageSearchTest extends TestCase {
    ...
    public void testNextPage(){
        ImageSearch ws = new ImageSearch();
        ...
        List<ImageSearchResult> results = ws.getResults();

        //should return a 200
        assertEquals(200,ws.getNextPage());

        List<ImageSearchResult> results2 = ws.getResults();
